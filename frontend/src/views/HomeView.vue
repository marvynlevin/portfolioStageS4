<template>
  ...
  <section class="h-screen w-full relative">
    ...
    <img class="absolute top-0 right-0 w-[150px] md:w-[300px] h-auto pointer-events-none select-none z-10 rounded-3xl"
         src="/bg1.png" alt="Photo de couleur pour le fond">
    <img class="absolute bottom-0 left-0 w-[150px] md:w-[300px] h-auto pointer-events-none select-none z-10 rounded-3xl"
...
export default {
  ...
  setup() {
    useHead({
      title: 'Marvyn Levin - Bienvenue',
      meta: [
        {
          name: 'description',
          content: 'Bienvenue sur mon profil ! Découvrez mon univers en tant qu’étudiant en BUT Informatique : mes projets, mes compétences en développement web et mes créations. Explorez mon portfolio et restez connecté pour de futures réalisations.'
        },
        {
          name: 'keywords',
          content: 'portfolio, profil, informatique, développement web, projets, créations, Symfony, Doctrine, Twig'
        },
        {
          property: 'og:title',
          content: 'Marvyn Levin - Bienvenue sur mon profil'
        },
        {
          property: 'og:description',
          content: 'Explorez mon profil et découvrez mes projets en développement web, mes compétences et mes créations.'
        },
        {
          property: 'og:type',
          content: 'website'
        ...
        },
        {
          ...
          content: 'Bienvenue sur mon profil ! Découvrez mes projets, compétences et créations en développement web.'
        },
        {
          name: 'twitter:image',
          content: 'https://www.marvynlevin.fr/icon.png'
